...
<body>
    ...
    <div id="form">
        ...
        <form method="post" action="exhibitions.php" >
            <ul>
                <li><input type="number" name="e_id" id="cname" placeholder="Enter the exhibition id"></li>
                <li><input type="date" name="start_date" id="customer_id" placeholder="Enter the start date"></li>
                <li><input type="date" name="end_date" id="address" placeholder="Enter the end date"></li>
                <li><input type="text" name="location" id="address" placeholder="Enter the location"></li>
