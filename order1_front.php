...
<head>
    ...
    <title>Gallery Noir|Order Now</title>
    <link rel="stylesheet" href="order2nd.css">
...
<body>
    ...
    <div id="form">
        ...
        <form method="post" action="order1.php" >
            <ul>
                <li><input type="number" name="order_id" id="order" placeholder="Enter your order ID"></li>
                <li><input type="number" name="customer_id" id="artwork" placeholder="Enter the customer ID"></li>
                <li id="button"><a href="order2_front.php"><button>Submit</button></a></li>
            </ul>
        </form>
    </div>
</head>
<body>
    ...
    <table class="table">
        <thead>
            <tr>
                <th class="heading">order_id</th>
                <th class="heading">customer_id</th>
                <th class="heading">order_date</th>
                <th class="heading">total_price</th>
