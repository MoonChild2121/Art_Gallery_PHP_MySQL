...
<body>
    ...
    <div id="form">
        ...
        <form method="post" action="artworks.php" >
            <ul>
                <li><input type="text" name="art_title" id="cname" placeholder="Enter the art title"></li>
                <li><input type="number" name="releaseyear" id="customer_id" placeholder="Enter the release year"></li>
                <li><input type="text" name="typeofart" id="customer_id" placeholder="Enter the typeofart"></li>

                <li><input type="number" name="price" id="address" placeholder="Enter the price"></li>
                <li><input type="number" name="artist_id" id="address" placeholder="Enter the artist id"></li>

                <li id="button"><a href="artworks_front.php"><button>Insert</button></a></li>
            </ul>
        </form>
    </div>
    <br>
    <table class="table">
        <thead>
            <tr>
                ...
                <th class="heading">Release Year</th>
                <th class="heading">Type of Art</th>
                <th class="heading">Price</th>
                <th class="heading">Artist ID</th>
